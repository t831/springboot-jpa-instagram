		...
		<header class="profile__header">
			...
			<div class="profile__info">
				...
				<p class="profile__bio">
					<span class="profile__fullname">Nicolás Serrano Arévalo</span> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptas repellendus cumque quo voluptatum voluptatem, maxime nobis. Quae incidunt cum expedita facilis libero officiis,
					delectus inventore tempore, ex nulla dolore cumque. <a href="http://serranoarevalo.com" class="profile__link">serranoarevalo.com</a>
				</p>
			</div>
		</header>
